...
- [ ] **I-1:** Criar **Dashboard Admin** (Métricas + Fila do Dia)
- [ ] **I-2:** Criar página **Gestão de Agendamentos** (DataTable com Filtros)
- [ ] **I-3:** Criar página **Gestão de Serviços** (Tabela + Form Modal)
- [ ] **I-4:** Criar página **Configurar Horários de Funcionamento** (Grade 7 Dias)
- [ ] **I-5:** Criar página **Gerenciar Bloqueios** (Calendário + Formulário)
- [ ] **I-6:** Criar página **Listagem de Usuários** (Pesquisa de Clientes)
