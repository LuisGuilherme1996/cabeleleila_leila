...
> Especificação detalhada dos endpoints, payloads, cabeçalhos, cookies e status HTTP da API REST exposta pelo backend Node.js + Express.
...
```json
{
  "resumoDoDia": {
    ...
    "concluidos": 2,
    "cancelados": 1,
    "faturamentoEstimado": 1350.0,
    "faturamentoRealizado": 150.0
  },
