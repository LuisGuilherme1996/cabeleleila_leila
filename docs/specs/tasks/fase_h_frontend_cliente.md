...
- [x] **H-1:** Criar página pública **Catálogo de Serviços**
- [x] **H-2:** Criar **Fluxo de Agendamento — Passo 1:** Selecionar Serviço
- [x] **H-3:** Criar **Fluxo de Agendamento — Passo 2:** Selecionar Data
- [x] **H-4:** Criar **Fluxo de Agendamento — Passo 3:** Selecionar Horário
- [x] **H-5:** Criar **Fluxo de Agendamento — Passo 4:** Resumo & Confirmação
- [x] **H-6:** Criar página **Meus Agendamentos** com histórico e cancelamento
